...
export default function HazelDellPage() {
    const neighborhoods = [
        { name: "Hazel Dell North", description: "Residential area with easy access to I-5" },
        { name: "Hazel Dell South", description: " established neighborhoods near Minnehaha" },
        { name: "Highway 99 Corridor", description: "Busy commercial and mixed-use district" },
        { name: "Starcrest", description: "Quiet streets with family homes" },
        { name: "Northeast Hazel Dell", description: "Growing community with new developments" },
    ]
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-3xl">
                        <div className="inline-flex items-center gap-2 bg-[#5dceeb]/20 backdrop-blur-sm border border-[#5dceeb]/30 px-4 py-2 rounded-full mb-6">
                            ...
                            <span className="text-sm font-medium">Serving Hazel Dell, WA</span>
                        </div>
                        <h1 className="text-4xl lg:text-5xl font-bold mb-6 text-balance">
                            Plumbing & Restoration in Hazel Dell
                        </h1>
                        <p className="text-xl text-white/90 mb-8 text-pretty">
                            Expert plumbing and water damage services for Hazel Dell and surrounding communities. 24/7 Emergency support.
                        </p>
            ...
            <section className="py-16 lg:py-24">
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-3xl font-bold mb-6">Hazel Dell's Local Plumbing Team</h2>
                        <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
                            <p>
                                Hazel Dell is a vital part of the Vancouver metro area, and Pilot Plumbing & Drain is dedicated to serving its residents and businesses.
                                Ideally located between Vancouver and Salmon Creek, Hazel Dell sees a lot of traffic and activity, which can put a strain on plumbing systems.
                            </p>
                            <p>
                                Whether you're a business owner on Highway 99 needing grease trap services or a homeowner in Starcrest with a leaky water heater,
                                our licensed plumbers have the expertise you need. We also specialize in rapid water extraction for basement floods during the rainy season.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto mt-12">
                        <Card className="border-2 hover:border-[#5dceeb]/50 transition-all">
                            <CardContent className="p-6">
                                ...
                                <p className="text-muted-foreground mb-4">Complete cleanup and drying for water damage events.</p>
                        ...
                        <Card className="border-2 hover:border-[#5dceeb]/50 transition-all">
                            <CardContent className="p-6">
                                ...
                                <p className="text-muted-foreground mb-4">From faucet leaks to sewer line replacement.</p>
