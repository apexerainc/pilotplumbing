...
export default function CamasPage() {
    const neighborhoods = [
        { name: "Downtown Camas", description: "Historic downtown with boutiques and dining" },
        { name: "Prune Hill", description: "Upscale residential area with views" },
        { name: "Lacamas Shores", description: "Luxury homes near the lake" },
        { name: "Fern Prairie", description: "Rural charm expanding with new homes" },
        { name: "Grass Valley", description: "Family-friendly suburban neighborhood" },
        { name: "Crown Park", description: "Established homes near the park" },
    ]
    ...
    return (
        <div className="flex flex-col">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-3xl">
                        <div className="inline-flex items-center gap-2 bg-[#5dceeb]/20 backdrop-blur-sm border border-[#5dceeb]/30 px-4 py-2 rounded-full mb-6">
                            ...
                            <span className="text-sm font-medium">Serving Camas, WA</span>
                        </div>
                        <h1 className="text-4xl lg:text-5xl font-bold mb-6 text-balance">
                            Plumbing & Restoration in Camas, WA
                        </h1>
                        <p className="text-xl text-white/90 mb-8 text-pretty">
                            Your local Camas experts for 24/7 emergency plumbing and water damage restoration. From Prune Hill to Lacamas Lake, we're here to help.
                        </p>
            ...
            <section className="py-16 lg:py-24">
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-3xl font-bold mb-6">Expert Plumbing & Restoration in Camas</h2>
                        <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
                            <p>
                                Pilot Plumbing & Drain is proud to serve the Camas community with top-tier plumbing and restoration services.
                                Whether you live in a historic home near downtown or a new build on Prune Hill, our team understands the local infrastructure and needs.
                            </p>
                            <p>
                                We provide rapid response to water emergencies, ensuring that your home is protected from the damp PNW climate.
                                Our certified technicians are experts in leak detection, water heater repair, and complete water damage restoration.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-16 lg:py-24 bg-muted">
                <div className="container mx-auto px-4">
                    <h2 className="text-3xl font-bold mb-12 text-center">Camas Neighborhoods We Serve</h2>
            ...
            <section className="py-16 lg:py-24">
                <div className="container mx-auto px-4">
                    <h2 className="text-3xl font-bold mb-4 text-center">Our Camas Services</h2>
                    <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto mt-12">
                        <Card className="border-2 hover:border-[#5dceeb]/50 transition-all">
                            <CardContent className="p-6">
                                ...
                                <p className="text-muted-foreground mb-4">Fast drying and restoration for leaks, floods, and burst pipes.</p>
                        ...
                        <Card className="border-2 hover:border-[#5dceeb]/50 transition-all">
                            <CardContent className="p-6">
                                ...
                                <p className="text-muted-foreground mb-4">Full-service plumbing repairs, installations, and maintenance.</p>
