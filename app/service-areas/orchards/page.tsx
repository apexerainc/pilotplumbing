                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-3xl">
                        ...
                        <h1 className="text-4xl lg:text-5xl font-bold mb-6 text-balance">
                            Plumbing & Restoration in Orchards
                        </h1>
                        <p className="text-xl text-white/90 mb-8 text-pretty">
                            Fast, reliable plumbing and water damage service for the Orchards community.
                        </p>
            ...
            <section className="py-16 lg:py-24">
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-3xl font-bold mb-6">Orchards Plumbing Professionals</h2>
                        <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
                            <p>
                                Pilot Plumbing & Drain is your local resource for all things plumbing and restoration in Orchards.
                                We are just minutes away and ready to handle emergencies 24/7.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto mt-12">
                        <Card className="border-2 hover:border-[#5dceeb]/50 transition-all">
                            <CardContent className="p-6">
                                ...
                                <p className="text-muted-foreground mb-4">Expert water removal and drying.</p>
                        ...
                        <Card className="border-2 hover:border-[#5dceeb]/50 transition-all">
                            <CardContent className="p-6">
                                ...
                                <p className="text-muted-foreground mb-4">Drain cleaning, repairs, and more.</p>
